...
import com.dreamteam.trafficmonitor.R.raw;
import com.dreamteam.trafficmonitor.R.string;
...
public final class Api {
	...
	// Messages
	public static final String STATUS_CHANGED_MSG 	= "com.dreamteam.trafficmonitor.intent.action.STATUS_CHANGED";
	public static final String TOGGLE_REQUEST_MSG	= "com.dreamteam.trafficmonitor.intent.action.TOGGLE_REQUEST";
	public static final String CUSTOM_SCRIPT_MSG	= "com.dreamteam.trafficmonitor.intent.action.CUSTOM_SCRIPT";
	// Message extras (parameters)
	public static final String STATUS_EXTRA			= "com.dreamteam.trafficmonitor.intent.extra.STATUS";
	public static final String SCRIPT_EXTRA			= "com.dreamteam.trafficmonitor.intent.extra.SCRIPT";
	public static final String SCRIPT2_EXTRA		= "com.dreamteam.trafficmonitor.intent.extra.SCRIPT2";
	...
	public static boolean hasRootAccess(final Context ctx, boolean showErrors) {
		...
		if (showErrors) {
			alert(ctx, "无法获得Root权限.\n" +
				"你的手机必须经过Root才能运行防火墙.\n\n" +
				"如果你的手机已经Root过，请保证本软件拥有执行 \"su\" 命令的权限.\n" +
